...
The `exactt` package tests whether a slope coefficient is equal to some null value in multivariate linear regression using the novel method described in Pouliot (2026). The package also inverts such a test to produce marginally valid confidence intervals. 
